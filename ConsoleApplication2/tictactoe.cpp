...
{
	TicTacToe::blockEntries[0] = "1";
	TicTacToe::blockEntries[1] = "2";
	TicTacToe::blockEntries[2] = "3";
	TicTacToe::blockEntries[3] = "4";
	TicTacToe::blockEntries[4] = "5";
	TicTacToe::blockEntries[5] = "6";
	TicTacToe::blockEntries[6] = "7";
	TicTacToe::blockEntries[7] = "8";
	TicTacToe::blockEntries[8] = "9";
	TicTacToe::turns = 10;
}
...
const void TicTacToe::getInput()  // get input from user and find winner
{
	...
	do
	{
		...
		{
			std::cout << std::endl;
			//sign = (player == 1) ? "X" : "O";//aici pune un if clasic ca nu prea stie ce ii baiu
			if (player == 1){
				sign = "X";}
			else{
				sign = "O";
